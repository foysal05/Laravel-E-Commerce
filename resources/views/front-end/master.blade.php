					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								...
								<img src="{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/images/p5.jpg" class="img-responsive" alt="">
								</div>
									...
									<div class="women">
										...
										<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3" data-name="Kabuli Chana" data-summary="summary 3" data-price="2.00" data-quantity="1" data-image="{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/images/of2.png">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								<div class="col-md-5 new-grid1">
								<img src="{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/images/p7.jpg" class="img-responsive" alt="">
								</div>
									<div class="col-md-7 new-grid">
										<h5>Ten Women's Cotton Viscose fabric Grey Shrug</h5>
										<h6>Quick Overview</h6>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								<div class="col-md-5 new-grid1">
								<img src="{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/images/p10.jpg" class="img-responsive" alt="">
								</div>
									<div class="col-md-7 new-grid">
										<h5>Ten Men Cotton Viscose fabric Grey Shrug</h5>
										<h6>Quick Overview</h6>
										<span>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span>
										<div class="color-quality">
											<div class="color-quality-left">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						...
						<div class="modal-body">
							<div class="news-gr">
								<div class="col-md-5 new-grid1">
								<img src="{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/{{asset('/')}}front-end/images/p12.jpg" class="img-responsive" alt="">
								</div>
									<div class="col-md-7 new-grid">
										<h5>Ten Men Cotton Viscose fabric Grey Shrug</h5>
										<h6>Quick Overview</h6>
