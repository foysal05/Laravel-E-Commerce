												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="{{ route('single-product',[$product->id]) }}" class="new-gri" >
																	<div class="grid-img">
														...
														<div class="women">
															<h6><a href="{{ route('single-product',[$product->id]) }}">{{ $product->product_name }}</a></h6>
															<span class="size">XL / XXL / S </span>
															<p ><em class="item_price">৳ {{ $product->product_price }}</em></p>
															<a href="{{ route('single-product',[$product->id]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
														</div>
													</div>
												</div>
												@endforeach
