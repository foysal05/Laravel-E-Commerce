							...
							<div class="col-md-3 arrival-grid simpleCart_shelfItem">
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="{{ route('single-product',[$newProduct->id]) }}" class="new-gri" data-toggle="modal" data-target="#myModal{{$newProduct->id}}">
												<div class="grid-img">
									...
									<div class="women">
										<h6><a href="{{ route('single-product',[$newProduct->id]) }}">{{ $newProduct->product_name }}</a></h6>
										<span class="size">XL / XXL / S </span>
										<p > <em class="item_price">৳{{ $newProduct->product_price }}</em></p>
										<a href="{{ route('single-product',[$newProduct->id]) }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
									</div>
								</div>
							</div>
							@endforeach
									...
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												...
												<div class="grid-img">
													<img  src="{{asset('/')}}front-end/{{asset('/')}}front-end/images/s1.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
								...
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{asset('/')}}front-end/{{asset('/')}}front-end/images/s4.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{asset('/')}}front-end/{{asset('/')}}front-end/images/s3.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
